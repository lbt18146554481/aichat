...
const CORE: PersonCore[] = [
  ...
  },
  {
    ...
    occupation_zh: "用户体验研究员",
    education: "Master's",
    education_zh: "硕士",
    educationLevel: "master",
    portrait: "UX researcher in Shanghai. Remembers how you take your coffee after meeting once.",
    portrait_zh: "上海的用户体验研究员。见过一次就记得你怎么喝咖啡。",
    signals: ["warm", "kind", "curious", "coffee", "city", "reading"],
    languages: ["zh-CN", "en"],
    angles: [
      {
        id: "warm-listener",
        signals: ["warm", "kind", "curious"],
        text: "Lin asks follow-up questions that don't feel like an interview — she remembers small things you said two conversations ago. Warm without hovering.",
        text_zh:
          "林溪会问跟进问题，但不像在面试——你两轮对话前随口说的小事她都记得。温暖，但不黏人。",
      },
      {
        id: "city-walker",
        signals: ["city", "coffee", "reading"],
        text: "She knows which lane in the French Concession still has an old bookstore. Walks slowly, talks easily.",
        text_zh: "她知道法租界哪条弄堂还藏着旧书店。走得很慢，聊得很顺。",
      },
    ],
  },
  {
    ...
    city: "Beijing",
    city_zh: "北京",
    occupation: "Live music curator",
    occupation_zh: "现场音乐策划",
    education: "Bachelor's",
    education_zh: "本科",
    educationLevel: "bachelor",
    portrait: "Books small venues in Beijing. Loud laugh, soft memory for lyrics.",
    portrait_zh: "在北京为小场地做演出策划。笑声很响，歌词记得很细。",
    signals: ["playful", "funny", "warm", "night", "music", "city", "film"],
    languages: ["zh-CN", "en"],
    angles: [
      {
        id: "night-host",
        signals: ["playful", "funny", "night", "music"],
        text: "Hao makes a room feel like everyone's already friends. He'll text you a setlist at midnight and mean it as an invitation.",
        text_zh: "陈皓会让一个房间像大家都已是朋友。半夜给你发演出歌单，那就是邀请。",
      },
      {
        id: "honest-hype",
        signals: ["warm", "film", "city"],
        text: "He hypes people he believes in — not everyone. When he says a band is worth leaving the house for, you go.",
        text_zh: "他只给真心相信的人加油——不是谁都捧。他说值得出门听的乐队，你就该去。",
      },
    ],
  },
  {
    ...
    education_zh: "本科",
    educationLevel: "bachelor",
    portrait: "Product manager in Shenzhen. Runs before the city wakes, climbs after work.",
    portrait_zh: "深圳的产品经理。城市醒之前跑步，下班之后攀岩。",
    signals: ["playful", "ambitious", "curious", "run", "climb", "city", "tennis"],
    languages: ["zh-CN", "en"],
    angles: [
      {
        id: "fast-start",
        signals: ["playful", "ambitious", "run"],
        text: "Yue treats the week like a prototype — ship, learn, try again. High energy, but she'll pause if you're still catching up.",
        text_zh: "孙悦把一周当原型——上线、学习、再试。精力很足，但你要是还没跟上，她会慢下来等你。",
      },
      {
        id: "weekend-climb",
        signals: ["climb", "curious", "city"],
        text: "She knows every bouldering gym in Nanshan and will drag you to the one with the best post-climb noodles.",
        text_zh: "南山哪家抱石馆最好、哪家抱完石面条最好吃，她门儿清，还会拉你一起去。",
      },
    ],
  },
  {
    ...
    city: "Chengdu",
    city_zh: "成都",
    occupation: "Tea studio owner",
    occupation_zh: "茶室主理人",
    education: "Associate",
    education_zh: "专科",
    educationLevel: "associate",
    portrait: "Runs a small tea studio in Chengdu. Cooks for friends like it's a holiday.",
    portrait_zh: "在成都经营一间小茶室。给朋友做饭像过节一样认真。",
    signals: ["warm", "kind", "funny", "cooking", "animals", "rain"],
    languages: ["zh-CN", "en"],
    angles: [
      {
        id: "kitchen-warmth",
        signals: ["warm", "kind", "cooking"],
        text: "Min feeds people before she asks how they are. Her tea room smells like citrus peel and she always saves you the corner seat.",
        text_zh: "苏敏往往是先给你盛一碗，再问你怎么样。茶室里有陈皮香，她总给你留着靠窗的位子。",
      },
      {
        id: "easy-laugh",
        signals: ["funny", "animals", "rain"],
        text: "She laughs at her own stories mid-sentence and has a cat who judges every guest. Rainy days are her favorite excuse to stay open late.",
        text_zh: "她讲到一半会先笑自己，还有一只猫负责打量每位客人。下雨天是她最喜欢晚点打烊的理由。",
      },
    ],
  },
];
...
const WHY_PERSON: Record<string, { en: string; zh: string }> = {
  ...
  lin: {
    en: "Warm in a way that remembers the small things — asks well, doesn't hover.",
    zh: "温暖会记得细节——问得好，也不黏人。",
  },
  hao: {
    en: "Playful host energy — makes a room feel open without forcing it.",
    zh: "有种把场子热起来的活泼劲儿——不尬聊，却让人想多说两句。",
  },
  yue: {
    en: "Fast-moving and curious — will slow down if you're still catching up.",
    zh: "行动快、好奇心强——你要是还没跟上，她会等你。",
  },
  min: {
    en: "Feeds you before she asks how you are — warmth you can taste.",
    zh: "往往是先给你盛一碗，再问你怎么样——暖得很具体。",
  },
};
...
> = {
  ...
  lin: {
    personBrief: {
      en: "Lin is a UX researcher in Shanghai. Remembers how you take your coffee, knows which lane still has an old bookstore. Warm without hovering.",
      zh: "林溪是上海的用户体验研究员。记得你怎么喝咖啡，也知道哪条弄堂还藏着旧书店。温暖，但不黏人。",
    },
    openerSuggestion: {
      en: "Hi — saw you like slow walks in the city. Any lane you'd take a friend down first?",
      zh: "嗨——看到你也喜欢在城里慢慢走。如果要带朋友逛，你会先走哪条弄堂？",
    },
    replyHints: {
      en: ["I'd follow that route.", "What's the bookstore at the end?"],
      zh: ["这条路我想走。", "尽头那家书店叫什么？"],
    },
  },
  hao: {
    personBrief: {
      en: "Hao books live music in Beijing. Loud laugh, texts setlists at midnight. Makes rooms feel like everyone's already friends.",
      zh: "陈皓在北京做现场音乐策划。笑声很响，半夜会发歌单。他所在的房间总像大家都已是朋友。",
    },
    openerSuggestion: {
      en: "Hi — what's the last show that made you leave the house on a weeknight?",
      zh: "嗨——最近一次让你工作日晚上也愿意出门的演出是什么？",
    },
    replyHints: {
      en: ["Worth it?", "Who was playing?"],
      zh: ["值吗？", "谁演的？"],
    },
  },
  yue: {
    personBrief: {
      en: "Yue is a product manager in Shenzhen. Runs before work, climbs after. Treats the week like a prototype.",
      zh: "孙悦是深圳的产品经理。上班前跑步，下班后攀岩。把一周当原型过。",
    },
    openerSuggestion: {
      en: "Hi — morning run or evening climb — which one saved your week lately?",
      zh: "嗨——最近是晨跑还是下班攀岩救了你这一周？",
    },
    replyHints: {
      en: ["Same — that hour is mine.", "Which gym has the best noodles after?"],
      zh: ["我也是——那一小时是属于自己的。", "哪家馆抱完石面条最好吃？"],
    },
  },
  min: {
    personBrief: {
      en: "Min runs a tea studio in Chengdu. Cooks for friends like a holiday, saves the corner seat, has a cat who judges guests.",
      zh: "苏敏在成都经营茶室。给朋友做饭像过节，总留靠窗位，还有一只猫负责打量客人。",
    },
    openerSuggestion: {
      en: "Hi — what's brewing in your studio when it rains?",
      zh: "嗨——下雨的时候你茶室里通常在泡什么？",
    },
    replyHints: {
      en: ["I'd sit for that.", "Does the cat approve of strangers?"],
      zh: ["这种天气我会坐一下午。", "那只猫对陌生人友好吗？"],
    },
  },
};

const SEED_GENDERS: Record<(typeof SEED_PERSON_IDS)[number], PersonGender> = {
  isa: "female",
  june: "female",
  theo: "male",
  mira: "female",
...
export function buildSeedPeople(): Person[] {
  return CORE.map((p) =>
    enrichPerson({
      ...p,
      gender: SEED_GENDERS[p.id as (typeof SEED_PERSON_IDS)[number]],
