...
export function IntroductionPane({
  ...
  return (
    <div className={`h-full overflow-y-auto ${compact ? "px-5 py-5" : "px-8 py-10"}`}>
      <div className={`mx-auto ${compact ? "max-w-full" : "max-w-md"}`}>
        {/* Identity */}
        ...
        {/* Neutral one-liner — context only, smaller */}
